...
import CalculatorForm from "../../calculator/components/CalculatorForm";
import CalculationResults from "../../calculator/components/CalculationResults";
import { useCardSelection } from "../../calculator/components/CalculatorHooks";
import {
  calculateRewards,
  setAuthToken,
  fetchCardQuestions,
...
function EmbeddableCalculator() {
  ...
  const handleClearAll = useCallback(() => {
    resetAllFields(); // Clear form inputs
    setCalculationResult(null); // Clear calculation results
    setCalculationPerformed(false); // Reset calculation performed flag
  }, [resetAllFields]);
