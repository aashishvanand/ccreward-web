...
const TermsOfServicePage = () => {
  ...
  const { trackComponentInteraction } = useComponentAnalytics('TermsOfServicePage');
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <Container component="main" sx={{ mt: 4, mb: 4, flexGrow: 1 }}>
        ...
        <Typography variant="body1" component="div">
          ...
          <div onFocus={() => handleSectionInteraction('service_infrastructure')}>
          ...
          <div onFocus={() => handleSectionInteraction('intellectual_property')}>
            ...
            <p>5.2. The source code for CCReward is available at <a 
              href="https://github.com/aashishvanand/ccreward-web" 
              target="_blank" 
              rel="noopener noreferrer"
              onClick={() => handleLinkClick('github_repo', 'https://github.com/aashishvanand/ccreward-web')}
            >https://github.com/aashishvanand/ccreward-web</a> under a dual license:</p>
            ...
            <p>Commercial license fees vary based on company size. Contact <a 
              href="mailto:support@ccreward.app"
              onClick={() => handleLinkClick('support_email', 'mailto:support@ccreward.app')}
            >support@ccreward.app</a> for licensing information.</p>
            ...
            <p>5.4. Financial institutions may request the removal of their logos or card images by contacting <a 
              href="mailto:support@ccreward.app"
              onClick={() => handleLinkClick('support_email', 'mailto:support@ccreward.app')}
            >support@ccreward.app</a>.</p>
          </div>
          ...
          <div onFocus={() => handleSectionInteraction('mobile_apps')}>
            ...
            <ul>
              <li>Apple App Store: <a 
                href="https://apps.apple.com/in/app/ccreward/id6736835206"
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => handleLinkClick('app_store', 'https://apps.apple.com/in/app/ccreward/id6736835206')}
              >CCReward for iOS</a></li>
              <li>Google Play Store: <a 
                href="https://play.google.com/store/apps/details?id=app.ccreward"
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => handleLinkClick('play_store', 'https://play.google.com/store/apps/details?id=app.ccreward')}
              >CCReward for Android</a></li>
            </ul>
            ...
            <ul>
              <li>Technical support is provided through <a 
                href="mailto:support@ccreward.app"
                onClick={() => handleLinkClick('support_email', 'mailto:support@ccreward.app')}
              >support@ccreward.app</a></li>
