...
const PrivacyPolicyPage = () => {
  ...
  const { trackComponentInteraction } = useComponentAnalytics('PrivacyPolicyPage');
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" component="div">
            ...
            <div onFocus={() => handleSectionInteraction('third_party_services')}>
            ...
            <div onFocus={() => handleSectionInteraction('advertising_preferences')}>
