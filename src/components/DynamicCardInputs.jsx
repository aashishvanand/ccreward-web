...
const DynamicCardInputs = ({
  ...
  const isShoppersStopTransaction =
    selectedMcc && selectedMcc.name.toLowerCase().includes("shoppers stop");
  const isFlipkartTransaction =
    selectedMcc && selectedMcc.name.toLowerCase().includes("flipkart");
  const isAmazonTransaction =
    selectedMcc && selectedMcc.name.toLowerCase().includes("amazon");
  ...
  return (
    <>
      {cardConfig.amazonPrimeRate && isAmazonTransaction && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          ...
          <RadioGroup
            ...
            onChange={(e) =>
              onChange("isPrimeMember", e.target.value === "true")
            }
            row
          >
      ...
      {cardConfig.flipkartPlusRate && isFlipkartTransaction && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          <FormLabel component="legend">
            Are you a Flipkart Plus member?
          </FormLabel>
          <RadioGroup
            ...
            onChange={(e) =>
              onChange("isFlipkartPlusMember", e.target.value === "true")
            }
            row
          >
            <FormControlLabel value="true" control={<Radio />} label="Yes" />
      ...
      {cardConfig.birthdayRate && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          <FormLabel component="legend">
            Is this a birthday month transaction?
          </FormLabel>
          <RadioGroup
      ...
      {cardConfig.acceleratedRewards?.travelEdgePortal && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          <FormLabel component="legend">
            Is this a Travel Edge Portal transaction?
          </FormLabel>
          <RadioGroup
            ...
            onChange={(e) =>
              onChange("isTravelEdgePortal", e.target.value === "true")
            }
            row
          >
            <FormControlLabel value="true" control={<Radio />} label="Yes" />
      ...
      {cardConfig.spicejetRate && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          <FormLabel component="legend">
            Is this a SpiceJet transaction?
          </FormLabel>
          <RadioGroup
      ...
      {cardConfig.airtelRate && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          <FormLabel component="legend">
            Is this an Airtel Thanks App transaction?
          </FormLabel>
          <RadioGroup
      ...
      {cardConfig.shoppersStopExclusiveBrands && isShoppersStopTransaction && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          <FormLabel component="legend">
            Is this a Shoppers Stop Exclusive Brand purchase?
          </FormLabel>
          <RadioGroup
            ...
            onChange={(e) =>
              onChange("isShoppersStopExclusive", e.target.value === "true")
            }
            row
          >
            <FormControlLabel value="true" control={<Radio />} label="Yes" />
      ...
      {cardConfig.freechargeRate && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          <FormLabel component="legend">
            Is this a Freecharge transaction?
          </FormLabel>
          <RadioGroup
            ...
            onChange={(e) =>
              onChange("isFreechargeTransaction", e.target.value === "true")
            }
            row
          >
            <FormControlLabel value="true" control={<Radio />} label="Yes" />
      ...
      {cardConfig.internationalRate && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          ...
          <RadioGroup
            ...
            value={
              currentInputs.isLICPremium
                ? "premium"
                : currentInputs.isSamsungTransaction
                ? "samsung"
                : currentInputs.isInternational
                ? "international"
                : "other"
            }
          ...
          >
            ...
            {cardConfig.samsungRate && (
              <FormControlLabel
                value="samsung"
                control={<Radio />}
                label="Samsung Purchase"
              />
            )}
            <FormControlLabel
              value="international"
              control={<Radio />}
              label={isSpecialCard ? "International Transaction" : "Yes"}
            />
            <FormControlLabel
              value="other"
              control={<Radio />}
              label={isSpecialCard ? "Other Transaction" : "No"}
            />
          </RadioGroup>
        </FormControl>
      )}
      ...
      {cardConfig.oneCard && (
        <FormControl component="fieldset" sx={{ mt: 2, width: "100%" }}>
          ...
          <RadioGroup
            ...
            onChange={(e) =>
              onChange("isTopCategorySpend", e.target.value === "true")
            }
            row
          >
            <FormControlLabel value="true" control={<Radio />} label="Yes" />
